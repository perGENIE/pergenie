-- AMR
DROP TABLE IF EXISTS `AMR_allele_freq`;
CREATE TABLE `AMR_allele_freq` (
...
LOAD DATA INFILE "/Volumes/Macintosh HD 2/reference/pergenie/umich_1kg_freq/AMR/AMR_allele_freq.csv" INTO TABLE `AMR_allele_freq` FIELDS TERMINATED BY ',';
