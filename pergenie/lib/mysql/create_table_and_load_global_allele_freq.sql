-- global
DROP TABLE IF EXISTS `global_allele_freq`;
CREATE TABLE `global_allele_freq` (
...
LOAD DATA INFILE "/Volumes/Macintosh HD 2/reference/pergenie/umich_1kg_freq/all/all_allele_freq.csv" INTO TABLE `global_allele_freq` FIELDS TERMINATED BY ',';
