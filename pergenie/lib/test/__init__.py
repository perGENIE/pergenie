...
class LoginUserTestCase(TestCase):
    ...
    def _delete_data(self):
        ...
        with MongoClient(host=settings.MONGO_URI) as c:
            ...
            # delete collection
            db.drop_collection(genomes.get_variants(self.test_user_id, self.file_cleaned_name_1).name)
            db.drop_collection(genomes.get_variants(self.test_user_id, self.file_cleaned_name_2).name)
